  ...
  return {
    ...
    proposed: {
      ...
      bws: {
        ...
        accessTokenSource: `${root}/secrets/employee_bws_access_token`,
        accessTokenFile: "/run/secrets/employee_bws_access_token",
        projectIdSource: `${root}/secrets/employee_bws_project_id`,
...
export function renderMSTeamsEmployeeOnboardingProvisioningStack(
  ...
  return {
    ...
    volumes: [
      ...
      {
        type: "bind",
        source: plan.proposed.bws.accessTokenSource,
        target: plan.proposed.bws.accessTokenFile,
        readOnly: true,
      },
      {
        type: "bind",
        source: plan.proposed.bws.projectIdSource,
        target: plan.proposed.bws.projectIdFile,
        readOnly: true,
      },
      {
        type: "bind",
...
export function createMSTeamsEmployeeOnboardingExecutionReadinessProof(params: {
  ...
  const requiredMountSources = [
    ...
    params.plan.proposed.bws.accessTokenSource,
    params.plan.proposed.bws.projectIdSource,
  ];
